  ...
  return (
    <header className="h-14 bg-white border-b border-border flex items-center justify-between px-4 flex-shrink-0">
      <div className="flex items-center gap-4 flex-1">
        <h1 className="text-[16px] font-semibold text-foreground">Inbox</h1>
        ...
        <div className="max-w-md w-full relative group">
          ...
          <input
            ...
            className="w-full bg-muted/40 border border-border/60 hover:border-border focus:bg-white focus:border-primary focus:ring-1 focus:ring-primary rounded-md pl-9 pr-4 py-1.5 text-sm placeholder:text-muted-foreground transition-all outline-none"
          />
        </div>
      </div>
